...
const stories = [
  {
    ...
    date: "2026-08-04",
    status: "current",
    publishedAt: "2026-09-25T19:30:00Z",
    replacesId: null,
  },
  {
    id: "cisco-webex-ai-agent-gpt54-2026-09",
    slot: "cisco",
    slotLabel: "Cisco",
  ...
  {
    id: "genesys-agentic-orchestration-xperience-2026-09",
    slot: "genesys",
    slotLabel: "Genesys",
    headline: "Genesys Cloud stakes agentic orchestration — with a real governance plane",
    take: "At Xperience (Sept. 2), Genesys introduced Navigator, Orchestrator, Contextual Intelligence, and an AI Control Plane as an integrated agentic stack for CX. Contextual Intelligence and the AI Control Plane are available now; Navigator targets Nov 2026–Jan 2027 GA, Orchestrator Feb–Apr 2027. The operator signal is not “more bots” — it’s journey state, next-best action across AI/people/systems, and centralized policy/observability as autonomy scales.",
  ...
  {
    id: "amazon-connect-agentic-cx-designer-ga-2026-09",
    ...
    take: "AWS announced GA of agentic CX designer (Sept. 2): a no-code canvas that combines agentic conversation with deterministic workflows for eligibility, approvals, routing, and compliance. Build/test/deploy in one place across major commercial regions. For Connect estates, the design question shifts from “can we script the IVR?” to “what must stay deterministic vs. conversational — and who owns the guardrails before production?”",
  ...
  {
    id: "ai-cx-best-buy-handoff-plumbing-2026-09",
    slot: "ai_cx",
    slotLabel: "AI in CX",
  ...
  {
    id: "regulation-us-rejects-un-ai-governance-2026-09",
    ...
    take: "On Sept. 23, White House OSTP Director Michael Kratsios told the UN Security Council the U.S. “totally rejects” efforts by international bodies to assert centralized control/global governance of AI, pointing instead to national sovereignty and the G20 Carolina Principles. Parallel UN tracks keep moving. For contact-center and AI programs: expect fragmented national rules, not a single global stack — design disclosure, audit, and data residency for the jurisdictions you serve.",
